...
content_planner_agent = Agent(
    ...
    instruction="""
        ...
        Using the default guideline, create a content plan based on the theme, goal and, audience for your client.
        ...
        Instructions:
            ...
            2. Create the Plan
                ...
                - Frequency: how often we’ll post.
                - Promotion: how we’ll share and grow reach.
            ...
            frequency: "2 posts and 1 video per week"
            promotion: "Share on social media, tag partners, and reuse content in emails"
            metrics: ["Website traffic", "Post engagement", "New subscribers"]
    """,
    tools=[google_search],
